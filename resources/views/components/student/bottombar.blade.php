@if (auth()->check() && auth()->user()->isFinishedTutorial() && auth()->user()->hasAvatarSet())
    <div
        ...
        <x-student.icon-clickable href="{{route('dev.blank', ['name' => 'Notification'])}}" normal="/students/nav/notification-min.png" active="/students/nav/notification-active-min.png" class="w-12 mx-2" />
