<div class="w-full">
    <div class=" w-full h-16 flex items-center justify-between px-1"
        ...
        <img src="/students/nav/text-logo.png" alt="" class="w-40">
    </div>
    <div class="h-8 w-full bg-gradient-to-r from-blue-300 via-blue-900 to-purple-900 flex items-center justify-end">
