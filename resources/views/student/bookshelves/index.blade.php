<x-student.layout>
    <div class="h-screen overflow-y-auto w-screen bg-white backdrop-blur-sm" style="background: url('/students/bs-bg.png'); background-size: cover; background-position:center; ">
