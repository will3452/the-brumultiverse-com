        ...
        <div x-data="data" x-effect="console.log(account)">
             ...
             <template x-if="step == 2">
                <div>
                    ...
                    <x-student.scene blur="1">
                        <img src="{{auth()->user()->getAssistant('image')}}" alt="" class="animate__animated animate__fadeInLeft block absolute -bottom-1/3">
                    </x-student.scene>
                </div>
             </template>
             ...
             <template x-if="step == 3">
                <div>
                    ...
                    <x-student.scene blur="1">
                        <img src=" {{auth()->user()->getAssistant('image')}}" alt="" class="block absolute -bottom-1/3">
                    </x-student.scene>
                </div>
             </template>
