    ...
    <div class="flex md:flex-wrap flex-wrap-reverse">
        <div class="w-full md:w-8/12">
            ...
            <x-scholar.page.update :editable="! $audio->hasPublishedDate()" :update-link="route('scholar.audiobook.update', ['audio' => $audio->id])">
                ...
                <x-scholar.form.number readonly="true" name="cost" value="{{$audio->cost}}" label="Cost" help="Please note that leaving the cost of your book in 0 will allow free access to readers, so long as they have hall passes or silver tickets. Please indicate price in CRYSTALS."/>
