    ...
    <div class="flex md:flex-wrap flex-wrap-reverse">
        <div class="w-full md:w-8/12">
            <x-scholar.page.update :editable="! $song->hasPublishedDate()" :update-link="route('scholars.song.update', ['song' => $song->id])">
                ...
                <x-scholar.form.number readonly="true" name="cost" value="{{$song->cost}}" label="Cost" help="Please note that leaving the cost to ZERO will allow the users to download it for FREE. Please indicate price in CRYSTALS."/>
