<x-scholar.layout>
    ...
    <x-scholar.material-container title="Marketing" icon="/img/icons/dashboard/trending-up.svg">
        <x-scholar.dashboard-card icon="/img/icons/dashboard/ballot_black_24dp.svg" title="bulletin" href="#" />
        <x-scholar.dashboard-card icon="/img/icons/dashboard/sort_black_24dp.svg" title="marquee" href="#"/>
        <x-scholar.dashboard-card icon="/img/icons/dashboard/slideshow_black_24dp.svg" title="sliding banner" href="#" />
        <x-scholar.dashboard-card icon="/img/icons/dashboard/quickreply_black_24dp.svg" title="message blast" href="#"/>
        <x-scholar.dashboard-card icon="/img/icons/dashboard/insert_photo_black_24dp.svg" title="loading image" href="#"/>
        <x-scholar.dashboard-card icon="/img/icons/dashboard/newspaper_black_24dp.svg" title="newspaper" href="#"/>
    </x-scholar.material-container>
